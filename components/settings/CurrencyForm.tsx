      ...
      <div className="flex items-end gap-3">
        <label className="flex flex-1 max-w-xs flex-col gap-1.5 text-sm font-medium text-text">
          ...
          <select
            ...
            className="rounded-[var(--radius-input)] border border-border bg-card px-4 py-2.5 text-sm text-text outline-none focus:border-accent focus:ring-2 focus:ring-accent/20"
          >
